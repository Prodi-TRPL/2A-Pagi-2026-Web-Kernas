...
class PegawaiController extends Controller
{
    ...
    // (alur data: fungsi ini menerima aksi simpan dari modal atur peran di view 'pegawai' baris 204, lalu memperbarui peran pengguna di database menggunakan model pengguna)
