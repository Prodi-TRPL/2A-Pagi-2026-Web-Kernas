...
@section('title', 'Form Surat Keputusan — KERNAS')
...
<div class="max-w-screen-xl mx-auto px-4 py-8">
    <div class="mb-6 flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Lengkapi informasi di bawah ini untuk menggenerate draft surat keputusan penetapan.</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <form action="/pengajuan/form/arahan-keputusan" method="POST" enctype="multipart/form-data" class="p-6 space-y-8">
            @csrf
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 mb-2">Nama dokumen ini di sistem (contoh: Surat Keputusan Direktur)</p>
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-800 mb-2">Tanggal Ditetapkan <span class="text-red-500">*</span></label>
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-800 mb-2">Tentang <span class="text-red-500">*</span></label>
                    <input type="text" name="TENTANG_SURAT" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none" placeholder="PENETAPAN PANITIA KEGIATAN MAHASISWA">
                </div>
                
                <div>
                    <label class="block text-sm font-semibold text-gray-800 mb-2">Memutuskan (Menetapkan Tentang) <span class="text-red-500">*</span></label>
                    <input type="text" name="MEMUTUSKAN" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none" placeholder="PENETAPAN PANITIA KEGIATAN MAHASISWA TAHUN 2026">
                </div>
            </div>
            ...
            <!-- Mengingat  -->
            <div class="space-y-4">
                <h3 class="text-sm font-bold text-sky-700 uppercase tracking-wider border-b pb-2">4. Dasar Mengingat</h3>
                
                <div class="bg-gray-50 p-4 rounded-xl border border-gray-200">
                    <p class="text-xs text-gray-500 mb-3">Pilih peraturan mana saja yang menjadi dasar/landasan penetapan ini.</p>
            ...
            <!-- Instruksi Dinamis -->
            <div class="space-y-4" x-data="{ instruksis: [''] }">
                <div class="flex items-center justify-between border-b pb-2">
                    <h3 class="text-sm font-bold text-sky-700 uppercase tracking-wider">5. Isi Keputusan / Instruksi</h3>
                    <button type="button" @click="instruksis.push('')" class="text-xs bg-sky-100 hover:bg-sky-200 text-sky-700 px-3 py-1 rounded-lg font-bold transition-colors">
                        + Tambah Keputusan
                    </button>
                </div>
                
                <template x-for="(instruksi, index) in instruksis" :key="index">
                    <div class="relative">
                        <label class="block text-sm font-semibold text-gray-800 mb-1" x-text="'Ketetapan ke-' + (index + 1)"></label>
                        <div class="flex gap-2 mb-4">
                            <!-- Label like KESATU, KEDUA will be auto-generated in backend -->
                            <textarea name="ISI_INSTRUKSI[]" x-model="instruksis[index]" rows="3" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 outline-none text-sm" placeholder="Keputusan..."></textarea>
                            <button type="button" x-show="instruksis.length > 1" @click="instruksis.splice(index, 1)" class="px-3 py-2 bg-red-50 text-red-500 hover:bg-red-100 rounded-lg transition-colors flex-shrink-0 flex items-center justify-center">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" /></svg>
                            </button>
                        </div>
                    </div>
