...
@section('title', 'Form Surat Perintah — KERNAS')
...
<div class="max-w-screen-xl mx-auto px-4 py-8">
    <div class="mb-6 flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Lengkapi informasi di bawah ini untuk menggenerate draft surat perintah.</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <form action="/pengajuan/form/arahan-perintah" method="POST" enctype="multipart/form-data" class="p-6 space-y-8">
            @csrf
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 mb-2">Nama dokumen ini di sistem (contoh: Surat Perintah Lembur)</p>
            ...
            <!-- Konsideran -->
            <div class="space-y-4">
                <h3 class="text-sm font-bold text-sky-700 uppercase tracking-wider border-b pb-2">3. Dasar Surat</h3>
                
                <div>
                    <label class="block text-sm font-semibold text-gray-800 mb-2">Menimbang <span class="text-red-500">*</span></label>
                    <textarea name="MENIMBANG_SURAT" rows="3" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none text-sm" placeholder="Bahwa untuk kelancaran tugas..."></textarea>
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-800 mb-2">Dasar <span class="text-red-500">*</span></label>
                    <textarea name="ATAS_DASAR" rows="3" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none text-sm" placeholder="Surat Edaran Direktur Nomor..."></textarea>
                </div>
            </div>

            <!-- Isi Perintah -->
            <div class="space-y-4">
                <h3 class="text-sm font-bold text-sky-700 uppercase tracking-wider border-b pb-2">4. Isi Perintah</h3>
                
                <div>
                    <label class="block text-sm font-semibold text-gray-800 mb-2">Kepada (Yang Diperintah) <span class="text-red-500">*</span></label>
                    <textarea name="PERINTAH" rows="3" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none text-sm" placeholder="1. Nama / NIP / Jabatan&#10;2. Nama / NIP / Jabatan"></textarea>
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-800 mb-2">Untuk (Tugas yang diberikan) <span class="text-red-500">*</span></label>
                    <textarea name="UNTUK" rows="4" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none text-sm" placeholder="Melaksanakan tugas kepanitiaan..."></textarea>
                </div>
            </div>
