...
@section('title', 'Form Surat Tugas (Biasa) — KERNAS')
...
<div class="max-w-screen-xl mx-auto px-4 py-8">
    <div class="mb-6 flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Lengkapi informasi di bawah ini untuk menggenerate draft surat tugas.</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <form action="/pengajuan/form/arahan-tugas-biasa" method="POST" enctype="multipart/form-data" class="p-6 space-y-8">
            @csrf
            ...
            <!-- Anggota Ditugaskan -->
            <div class="space-y-4" x-data="{ selectedUser: '' }">
                <h3 class="text-sm font-bold text-sky-700 uppercase tracking-wider border-b pb-2">3. Pegawai yang Ditugaskan</h3>
                
                <div>
                    <label class="block text-sm font-semibold text-gray-800 mb-2">Pilih Pegawai <span class="text-red-500">*</span></label>
                    <select name="id_pengguna" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none text-sm" @change="selectedUser = $event.target.options[$event.target.selectedIndex].text">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="TUGAS" rows="2" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none text-sm" placeholder="Menghadiri rapat koordinasi..."></textarea>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                    <div>
                        ...
                        <input type="text" name="TANGGAL_TUGAS" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none text-sm" placeholder="10 s.d. 12 Agustus 2026">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-800 mb-2">Lokasi Penugasan <span class="text-red-500">*</span></label>
                        <input type="text" name="LOKASI_TUGAS" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none text-sm" placeholder="Hotel ABC, Jakarta">
                    </div>
                </div>
            </div>
