...
<div class="max-w-screen-xl mx-auto px-4 py-8" x-data="suratForm(@js($penggunas))">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <form action="/pengajuan/form/contoh-surat-satu" method="POST" enctype="multipart/form-data" class="p-6 space-y-8">
            ...
            <!-- Lampiran Opsional -->
            <div class="space-y-4">
                <h3 class="text-sm font-bold text-sky-700 uppercase tracking-wider border-b pb-2">4. Lampiran Pendukung</h3>
                ...
                <div x-data="{ 
                    ...
                    addFiles(fileList) {
                        ...
                        // Masukkan file baru (hindari duplikat berdasarkan nama)
                    ...
                    <div @dragover.prevent="isDropping = true"
                        ...
                        <input x-ref="fileInput" type="file" name="file_lampiran[]" multiple @change="addFiles($event.target.files)" class="hidden">
                        ...
                        <div class="flex flex-col items-center justify-center pointer-events-none">
                            ...
                            <p class="text-sm font-medium text-gray-800">Unggah File Lampiran (Opsional)</p>
                            ...
                            <p class="text-[10px] text-gray-400 mt-2">Bisa pilih lebih dari 1 file sekaligus, dan file baru akan otomatis ditambahkan.</p>
