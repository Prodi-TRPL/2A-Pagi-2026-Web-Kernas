...
@section('title', 'Form Surat Pernyataan — KERNAS')
...
<div class="max-w-screen-xl mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <form action="/pengajuan/form/dinas-khusus-pernyataan" method="POST" enctype="multipart/form-data" class="p-6 space-y-8">
            @csrf
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <input type="text" name="judul" required placeholder="Contoh: Surat Pernyataan Tanggung Jawab Mutlak" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none text-sm transition-shadow">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-800 mb-2">Nama Pembuat Pernyataan <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-800 mb-2">NIP Pembuat Pernyataan <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-800 mb-2">Pangkat Pembuat Pernyataan <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-800 mb-2">Golongan Pembuat Pernyataan <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-800 mb-2">Jabatan Pembuat Pernyataan <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-800 mb-2">Alamat Pembuat Pernyataan <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-800 mb-2">Isi Pernyataan <span class="text-red-500">*</span></label>
                        <textarea name="PERNYATAAN_SURAT" rows="3" required placeholder="Menyatakan bahwa..." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none text-sm transition-shadow"></textarea>
                    </div>
                </div>
            </div>
