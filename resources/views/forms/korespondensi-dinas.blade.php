...
@section('title', 'Form Surat Dinas — KERNAS')
...
<div class="max-w-screen-xl mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <form action="/pengajuan/form/korespondensi-dinas" method="POST" enctype="multipart/form-data" class="p-6 space-y-8">
            @csrf
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <input type="text" name="judul" required placeholder="Contoh: Surat Dinas Undangan" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none text-sm transition-shadow">
                    </div>
                    
                    <div>
                        <label class="block text-sm font-semibold text-gray-800 mb-2">Hal <span class="text-red-500">*</span></label>
                        <input type="text" name="hal" required placeholder="Contoh: Permohonan Narasumber" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none text-sm transition-shadow">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-800 mb-2">Penerima Surat <span class="text-red-500">*</span></label>
                        <textarea name="penerima_surat" rows="3" required placeholder="Contoh: Yth. Direktur Jenderal Pendidikan Vokasi" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none text-sm transition-shadow"></textarea>
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-800 mb-2">Kalimat Pembuka <span class="text-red-500">*</span></label>
                        <textarea name="kalimat_pembuka" rows="3" required placeholder="Contoh: Dengan hormat, bersama ini kami sampaikan ..." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none text-sm transition-shadow"></textarea>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <textarea name="kalimat_penutup" rows="3" required placeholder="Contoh: Demikian permohonan ini kami sampaikan." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none text-sm transition-shadow"></textarea>
                    </div>
                </div>
            </div>
