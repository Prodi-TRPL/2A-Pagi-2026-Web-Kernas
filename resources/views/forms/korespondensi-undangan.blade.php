...
@section('title', 'Form Surat Undangan — KERNAS')
...
<div class="max-w-screen-xl mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <form action="/pengajuan/form/korespondensi-undangan" method="POST" enctype="multipart/form-data" class="p-6 space-y-8">
            @csrf
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <input type="text" name="judul" required placeholder="Contoh: Undangan Rapat Pimpinan" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none text-sm transition-shadow">
                    </div>
                    
                    <div>
                        <label class="block text-sm font-semibold text-gray-800 mb-2">Hal <span class="text-red-500">*</span></label>
                        <input type="text" name="hal" required placeholder="Contoh: Undangan Rapat Koordinasi" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none text-sm transition-shadow">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-800 mb-2">Penerima Surat <span class="text-red-500">*</span></label>
                        <textarea name="penerima_surat" rows="3" required placeholder="Contoh: Yth. Para Wakil Direktur" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none text-sm transition-shadow"></textarea>
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-800 mb-2">Kalimat Pembuka <span class="text-red-500">*</span></label>
                        <textarea name="kalimat_pembuka" rows="3" required placeholder="Contoh: Mengharap kehadiran Bapak/Ibu pada rapat ..." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none text-sm transition-shadow"></textarea>
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-800 mb-2">Hari dan Tanggal Acara <span class="text-red-500">*</span></label>
                        <input type="text" name="hari_tanggal_acara" required placeholder="Contoh: Senin, 12 Agustus 2026" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none text-sm transition-shadow">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-800 mb-2">Waktu Acara <span class="text-red-500">*</span></label>
                        <input type="text" name="waktu_acara" required placeholder="Contoh: 09:00 WIB s.d. Selesai" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none text-sm transition-shadow">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-800 mb-2">Tempat Acara <span class="text-red-500">*</span></label>
                        <input type="text" name="tempat_acara" required placeholder="Contoh: Ruang Rapat Utama Gedung A" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none text-sm transition-shadow">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-800 mb-2">Nama Acara <span class="text-red-500">*</span></label>
                        <input type="text" name="nama_acara" required placeholder="Contoh: Rapat Koordinasi Anggaran" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none text-sm transition-shadow">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-800 mb-2">Kalimat Penutup <span class="text-red-500">*</span></label>
                        <textarea name="kalimat_penutup" rows="3" required placeholder="Contoh: Demikian undangan ini kami sampaikan, atas kehadirannya diucapkan terima kasih." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none text-sm transition-shadow"></textarea>
                    </div>
                </div>
            </div>
            ...
            <!-- lampiran (opsional) -->
            <div class="space-y-4">
                <h3 class="text-sm font-bold text-sky-700 uppercase tracking-wider border-b pb-2">3. Lampiran Pendukung</h3>
