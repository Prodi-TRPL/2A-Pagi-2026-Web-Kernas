                                ...
                                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 flex-1">
                                    <div>
                                        ...
                                        <div x-data="{ open: false, search: '' }" class="relative" @click.away="open = false">
                                            ...
                                            <!-- Hidden input agar data terkirim saat form submit -->
                                            <input type="hidden" :name="'diusulkan['+index+'][id_pengguna]'" :value="orang.id_pengguna" required>
                                        </div>
                                    </div>
                                    <div>
            ...
            <div class="space-y-4">
                ...
                <div x-data="{ 
                    ...
                    addFiles(fileList) {
                        ...
                        if (rejected.length > 0) alert('File berikut ditolak karena bukan PDF:\n' + rejected.join('\n'));
                    },
                    removeFile(index) {
                        let dt = new DataTransfer();
