    ...
    <nav class="bg-white border-b border-gray-200 sticky top-0 z-40">
        <div class="max-w-screen-xl mx-auto px-4">
            ...
            <div class="hidden md:flex items-center gap-1 border-t border-gray-100">
                ...
                <a href="/dokumen-terbit" class="flex items-center gap-1.5 px-3 py-2 text-sm transition-colors {{ request()->is('dokumen-terbit') ? 'font-medium text-sky-600 border-b-2 border-sky-500' : 'text-gray-600 rounded-md hover:bg-gray-100 hover:text-gray-900' }}">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
