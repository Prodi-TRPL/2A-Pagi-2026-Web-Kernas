<nav class="bg-white border-b border-gray-200 sticky top-0 z-40">
    <div class="px-2">
        <div class="flex items-center justify-between h-14">
            ...
            <div class="flex items-center gap-3">
                <div class="text-right hidden sm:block">
                    <p class="text-sm font-semibold text-gray-800">Achmal Febriansyah</p>
                    <p class="text-xs text-gray-500">Admin</p>
                </div>
                <div class="px-2" x-data="{ open: false }">
                    <button @click="open = !open" class="w-9 h-9 rounded-full bg-sky-600 flex items-center justify-center text-white text-sm font-bold">
                        {{ strtoupper(substr("Achmal Febriansyah" ?? 'U', 0, 2)) }}
                    </button>
        ...
        {{-- link nav --}}
        <div class="hidden md:flex items-center gap-1 border-t border-gray-200">
            <a href="/dashboard-admin" class="flex items-center gap-1.5 px-3 py-2 text-sm text-gray-600 rounded-md hover:bg-gray-100 hover:text-gray-900 transition-colors">
            ...
            <a href="/riwayat-admin" class="flex items-center gap-1.5 px-3 py-2 text-sm text-gray-600 rounded-md hover:bg-gray-100 hover:text-gray-900 transition-colors">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
