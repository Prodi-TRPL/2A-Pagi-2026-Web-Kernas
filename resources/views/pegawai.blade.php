                        ...
                        <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-4 py-3 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <button
                                        @click="hapusPegawai(karyawan.id, karyawan.nama)"
                                        class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg border border-red-300 text-red-700 bg-red-50 hover:bg-red-100 hover:border-red-400 transition-colors"
                                    >
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
    ...
    <script>
        function manajemenKaryawan(initialKaryawan, initialGrupVerifikasi) {
            return {
                ...
                grupVerifikasi: Array.isArray(initialGrupVerifikasi) ? initialGrupVerifikasi : Object.values(initialGrupVerifikasi || {}),
                karyawan: Array.isArray(initialKaryawan) ? initialKaryawan : Object.values(initialKaryawan || {}),
                ...
                async hapusPegawai(id, nama) {
                    ...
                    try {
                        ...
                        if (res.ok) {
                            this.karyawan = Object.values(this.karyawan).filter(k => k.id !== id);
                            this.showToast(`Pegawai ${nama} berhasil dihapus`);
                        } else {
                            this.showToast('Gagal menghapus pegawai');
                        }
                    } catch (e) {
                        this.showToast('Terjadi kesalahan server: ' + (e.message || e));
                    }
                },
